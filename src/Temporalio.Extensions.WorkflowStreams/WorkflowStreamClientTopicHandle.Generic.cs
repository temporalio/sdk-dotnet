...
{
    /// <summary>A strongly typed client-side handle bound to one topic.</summary>
    ...
    public sealed class WorkflowStreamClientTopicHandle<T>
    {
        ...
        /// <summary>Buffers a pre-built Temporal payload for publication on this topic.</summary>
