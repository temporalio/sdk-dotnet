...
{
    /// <summary>A strongly typed workflow-side handle bound to one topic.</summary>
    ...
    public sealed class WorkflowStreamTopicHandle<T>
    {
        ...
        /// <summary>Appends a pre-built Temporal payload to the workflow's durable stream log.</summary>
