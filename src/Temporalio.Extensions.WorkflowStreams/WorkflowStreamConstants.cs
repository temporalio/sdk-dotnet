...
namespace Temporalio.Extensions.WorkflowStreams
{
    ...
    public static class WorkflowStreamConstants
    {
        ...
        /// <summary>
        /// Keeps each update result comfortably below server payload limits.
        /// </summary>
        internal const int MaxPollResponseBytes = 1_000_000;

        /// <summary>
        /// Matches the batching cadence shared with other SDK implementations.
        /// </summary>
        internal static readonly TimeSpan DefaultBatchInterval = TimeSpan.FromSeconds(2);

        /// <summary>
        /// Stays below the default publisher TTL to preserve deduplication.
        /// </summary>
        internal static readonly TimeSpan DefaultMaxRetryDuration = TimeSpan.FromMinutes(10);

        /// <summary>
        /// Avoids tight polling while keeping interactive latency low.
        /// </summary>
        internal static readonly TimeSpan DefaultPollCooldown = TimeSpan.FromMilliseconds(100);

        /// <summary>
        /// Bounds deduplication metadata carried through continue-as-new.
        /// </summary>
        internal static readonly TimeSpan DefaultPublisherTtl = TimeSpan.FromMinutes(15);

        /// <summary>
        /// Bounds each transport attempt while retaining the accepted update handle.
        /// </summary>
