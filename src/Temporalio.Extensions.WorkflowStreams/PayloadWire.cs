...
{
    /// <summary>
    /// Preserves payload metadata in cross-language JSON envelopes.
    /// </summary>
    internal static class PayloadWire
    {
        /// <summary>
        /// Encodes a payload as base64 protobuf bytes.
        /// </summary>
        /// <param name="payload">
        /// Payload to encode.
        /// </param>
        /// <returns>
        /// The padded base64 wire value.
        /// </returns>
        internal static string Encode(Payload payload) =>
            Convert.ToBase64String(payload.ToByteArray());

        /// <summary>
        /// Decodes base64 protobuf bytes into a payload.
        /// </summary>
        /// <param name="data">
        /// Padded base64 wire value.
        /// </param>
        /// <returns>
        /// The decoded payload.
        /// </returns>
        ...
        /// <summary>
        /// Approximates an item's JSON response contribution consistently with peers.
        /// </summary>
        ...
        /// </param>
        /// <returns>
        /// The approximate byte contribution.
        /// </returns>
