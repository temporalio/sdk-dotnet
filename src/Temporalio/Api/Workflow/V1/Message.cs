...
namespace Temporalio.Api.Workflow.V1 {
  ...
  #endif
  {
    ...
    public string LastIndependentlyAssignedBuildId {
      get { return assignedBuildIdCase_ == AssignedBuildIdOneofCase.LastIndependentlyAssignedBuildId ? (string) assignedBuildId_ : ""; }
      set {
        assignedBuildId_ = pb::ProtoPreconditions.CheckNotNull(value, "value");
    ...
    public override int GetHashCode() {
      ...
      if (assignedBuildIdCase_ == AssignedBuildIdOneofCase.LastIndependentlyAssignedBuildId) hash ^= LastIndependentlyAssignedBuildId.GetHashCode();
    ...
    public void WriteTo(pb::CodedOutputStream output) {
      ...
      if (assignedBuildIdCase_ == AssignedBuildIdOneofCase.LastIndependentlyAssignedBuildId) {
