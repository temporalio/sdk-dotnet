...
namespace Temporalio.Api.Enums.V1 {
    ...
    static FailedCauseReflection() {
      byte[] descriptorData = global::System.Convert.FromBase64String(
          string.Concat(
            ...
            "ZW1wb3JhbC5hcGkuZW51bXMudjEq3hMKF1dvcmtmbG93VGFza0ZhaWxlZENh",
            ...
            "R1JQQ19NRVNTQUdFX1RPT19MQVJHRRAkEjEKLVdPUktGTE9XX1RBU0tfRkFJ",
            "TEVEX0NBVVNFX1BBWUxPQURTX1RPT19MQVJHRRAlEjcKM1dPUktGTE9XX1RB",
            "U0tfRkFJTEVEX0NBVVNFX0VYVEVSTkFMX1NUT1JBR0VfRkFJTFVSRRAmEksK",
            "R1dPUktGTE9XX1RBU0tfRkFJTEVEX0NBVVNFX1dPUktGTE9XX1BBVVNFX1JF",
            "UVVFU1RFRF9CRUZPUkVfVEFTS19TVEFSVEVEECcqwAIKJlN0YXJ0Q2hpbGRX",
            ...
            "RF9DQVVTRV9JTlZBTElEX1ZFUlNJT05JTkdfT1ZFUlJJREUQAyqRAgoqQ2Fu",
            "Y2VsRXh0ZXJuYWxXb3JrZmxvd0V4ZWN1dGlvbkZhaWxlZENhdXNlEj8KO0NB",
            "TkNFTF9FWFRFUk5BTF9XT1JLRkxPV19FWEVDVVRJT05fRkFJTEVEX0NBVVNF",
            "X1VOU1BFQ0lGSUVEEAASWQpVQ0FOQ0VMX0VYVEVSTkFMX1dPUktGTE9XX0VY",
            "RUNVVElPTl9GQUlMRURfQ0FVU0VfRVhURVJOQUxfV09SS0ZMT1dfRVhFQ1VU",
            "SU9OX05PVF9GT1VORBABEkcKQ0NBTkNFTF9FWFRFUk5BTF9XT1JLRkxPV19F",
            "WEVDVVRJT05fRkFJTEVEX0NBVVNFX05BTUVTUEFDRV9OT1RfRk9VTkQQAiri",
            "AgoqU2lnbmFsRXh0ZXJuYWxXb3JrZmxvd0V4ZWN1dGlvbkZhaWxlZENhdXNl",
            "Ej8KO1NJR05BTF9FWFRFUk5BTF9XT1JLRkxPV19FWEVDVVRJT05fRkFJTEVE",
            "X0NBVVNFX1VOU1BFQ0lGSUVEEAASWQpVU0lHTkFMX0VYVEVSTkFMX1dPUktG",
            "TE9XX0VYRUNVVElPTl9GQUlMRURfQ0FVU0VfRVhURVJOQUxfV09SS0ZMT1df",
            "RVhFQ1VUSU9OX05PVF9GT1VORBABEkcKQ1NJR05BTF9FWFRFUk5BTF9XT1JL",
            "RkxPV19FWEVDVVRJT05fRkFJTEVEX0NBVVNFX05BTUVTUEFDRV9OT1RfRk9V",
            "TkQQAhJPCktTSUdOQUxfRVhURVJOQUxfV09SS0ZMT1dfRVhFQ1VUSU9OX0ZB",
            "SUxFRF9DQVVTRV9TSUdOQUxfQ09VTlRfTElNSVRfRVhDRUVERUQQAyqXBAoW",
            "UmVzb3VyY2VFeGhhdXN0ZWRDYXVzZRIoCiRSRVNPVVJDRV9FWEhBVVNURURf",
            "Q0FVU0VfVU5TUEVDSUZJRUQQABImCiJSRVNPVVJDRV9FWEhBVVNURURfQ0FV",
            "U0VfUlBTX0xJTUlUEAESLQopUkVTT1VSQ0VfRVhIQVVTVEVEX0NBVVNFX0NP",
            "TkNVUlJFTlRfTElNSVQQAhIuCipSRVNPVVJDRV9FWEhBVVNURURfQ0FVU0Vf",
            "U1lTVEVNX09WRVJMT0FERUQQAxIuCipSRVNPVVJDRV9FWEhBVVNURURfQ0FV",
            "U0VfUEVSU0lTVEVOQ0VfTElNSVQQBBIqCiZSRVNPVVJDRV9FWEhBVVNURURf",
            "Q0FVU0VfQlVTWV9XT1JLRkxPVxAFEiYKIlJFU09VUkNFX0VYSEFVU1RFRF9D",
            "QVVTRV9BUFNfTElNSVQQBhI2CjJSRVNPVVJDRV9FWEhBVVNURURfQ0FVU0Vf",
            "UEVSU0lTVEVOQ0VfU1RPUkFHRV9MSU1JVBAHEjEKLVJFU09VUkNFX0VYSEFV",
            "U1RFRF9DQVVTRV9DSVJDVUlUX0JSRUFLRVJfT1BFThAIEiYKIlJFU09VUkNF",
            "X0VYSEFVU1RFRF9DQVVTRV9PUFNfTElNSVQQCRI1CjFSRVNPVVJDRV9FWEhB",
            "VVNURURfQ0FVU0VfV09SS0VSX0RFUExPWU1FTlRfTElNSVRTEAoqjwEKFlJl",
            "c291cmNlRXhoYXVzdGVkU2NvcGUSKAokUkVTT1VSQ0VfRVhIQVVTVEVEX1ND",
            "T1BFX1VOU1BFQ0lGSUVEEAASJgoiUkVTT1VSQ0VfRVhIQVVTVEVEX1NDT1BF",
            "X05BTUVTUEFDRRABEiMKH1JFU09VUkNFX0VYSEFVU1RFRF9TQ09QRV9TWVNU",
            "RU0QAkKIAQoYaW8udGVtcG9yYWwuYXBpLmVudW1zLnYxQhBGYWlsZWRDYXVz",
  ...
  public enum WorkflowTaskFailedCause {
    ...
    /// </summary>
    [pbr::OriginalName("WORKFLOW_TASK_FAILED_CAUSE_PAYLOADS_TOO_LARGE")] PayloadsTooLarge = 37,
    /// <summary>
    /// A workflow task failed because an external storage operation failed.
    /// Check the workflow task failure message for more information.
    /// </summary>
    [pbr::OriginalName("WORKFLOW_TASK_FAILED_CAUSE_EXTERNAL_STORAGE_FAILURE")] ExternalStorageFailure = 38,
    /// <summary>
    /// A workflow task is failed because the workflow is paused before the task is started.
    /// </summary>
    [pbr::OriginalName("WORKFLOW_TASK_FAILED_CAUSE_WORKFLOW_PAUSE_REQUESTED_BEFORE_TASK_STARTED")] WorkflowPauseRequestedBeforeTaskStarted = 39,
  }
