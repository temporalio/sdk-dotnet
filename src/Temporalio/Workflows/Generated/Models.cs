...
namespace Temporalio.Workflows
{
    ...
    internal class SignalWithStartWorkflowRequest
    {
        ...
        {
            get => _namespace ?? TemporalWorkflowContext.WorkflowNamespace();
        ...
        {
            return new SignalWithStartWorkflowRequest(ProtoExtensions.FromWorkflowTypeProto(wire.WorkflowType), wire.WorkflowId, ProtoExtensions.FromTaskQueueProto(wire.TaskQueue), wire.SignalName)
            {
    ...
    {
        internal SignalWithStartWorkflowResponse(string firstExecutionRunId)
        {
        ...
        {
            return new SignalWithStartWorkflowResponse(wire.FirstExecutionRunId)
            {
        ...
        internal Temporalio.Api.WorkflowService.V1.SignalWithStartWorkflowExecutionResponse ToTransferType()
        {
            ...
            proto.FirstExecutionRunId = FirstExecutionRunId;
            return proto;
        }
