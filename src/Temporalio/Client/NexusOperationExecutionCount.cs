...
namespace Temporalio.Client
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NexusOperationExecutionCount" /> class.
        /// </summary>
        /// <param name="raw">Raw proto.</param>
        /// <remarks>WARNING: This constructor may be mutated in backwards incompatible ways.</remarks>
        protected internal NexusOperationExecutionCount(CountNexusOperationExecutionsResponse raw)
        {
            Count = raw.Count;
        ...
        public class AggregationGroup
        {
            ...
            /// <param name="raw">Raw proto.</param>
            /// <remarks>WARNING: This constructor may be mutated in backwards incompatible ways.</remarks>
            protected internal AggregationGroup(CountNexusOperationExecutionsResponse.Types.AggregationGroup raw)
            {
                Count = raw.Count;
