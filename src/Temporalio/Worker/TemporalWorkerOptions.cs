...
namespace Temporalio.Worker
{
    ...
    public class TemporalWorkerOptions : ICloneable
    {
        ...
        /// <summary>
        /// Gets or sets whether this worker opts into the worker versioning feature. This ensures it only receives
        /// workflow tasks for workflows which it claims to be compatible with. The <see cref="BuildID"/> field
        /// is used as this worker's version when enabled, and must be set.
        /// </summary>
