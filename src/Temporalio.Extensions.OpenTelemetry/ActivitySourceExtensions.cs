...
namespace Temporalio.Extensions.OpenTelemetry
{
    ...
    {
        /// <summary>
        /// Create a <see cref="WorkflowActivity" /> and set it as current. Can only be called
        /// within a workflow. WARNING: This method should not be considered stable and may change.
        /// </summary>
        ...
        /// WorkflowActivity will be prepended to any given tags and used. If false, only given tags
        /// are used. This differs from standard <c>ActivitySource.StartActivity</c> behavior by
        /// intention so workflow tags can be propagated.</param>
        ...
        /// <remarks>
        /// This starts and immediately stops a <see cref="Activity" /> since workflows do not
        ...
        /// </remarks>
        public static WorkflowActivity StartWorkflowActivity(
            ...
            Action<Activity>? updateActivity = null)
        {
            ...
            if (inheritParentTags &&
                WorkflowActivity.Current?.Tags is IReadOnlyCollection<KeyValuePair<string, object?>> parentTags)
            {
                if (tags == null)
                {
            ...
            var parentContext = WorkflowActivity.Current?.Context ?? default;
